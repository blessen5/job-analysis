...
CANONICAL_SCHEMA: Dict[str, str] = {
    ...
    "job_title": "Title of the job position as posted",
    ...
    "remote_type": "Work modality specification: Remote, Hybrid, Onsite, Unspecified",
    "salary_min": "Lower bound of annual salary range",
    "salary_max": "Upper bound of annual salary range",
    "salary_currency": "3-letter currency code (INR, USD, etc.)",
    "experience": "Seniority / experience level: Entry, Mid, Senior, Lead, Executive, Unspecified",
    "employment_type": "Employment terms: Full-time, Part-time, Contract, Internship, Unspecified",
    "description": "Full text body of the job advertisement",
    "posted_date": "Publication date of job posting",
